{
  citron = {
    ...
    version = "nightly-356b62908";
    url = "https://github.com/citron-neo/CI/releases/download/nightly-linux/citron_nightly-356b62908-linux-x86_64_v3.AppImage";
    sha256 = "sha256-Wr0NZz/IyJfkvS2tQSHZns0ZW+odKjr0dIXgTGNOd84=";
