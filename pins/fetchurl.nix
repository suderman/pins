{
  citron = {
    ...
    version = "nightly-d7072013a";
    url = "https://github.com/citron-neo/CI/releases/download/nightly-linux/citron_nightly-d7072013a-linux-x86_64_v3.AppImage";
    sha256 = "sha256-p/4ymfUVfIPmJGkqhsocUJM0edVcp4TecICbp5Tz76s=";
