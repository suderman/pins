{
  citron = {
    ...
    version = "nightly-4642bb3e3";
    url = "https://github.com/citron-neo/CI/releases/download/nightly-linux/citron_nightly-4642bb3e3-linux-x86_64_v3.AppImage";
    sha256 = "sha256-le8HFZvgxe0lX6ASk9jKLRtjDdmUTecsRLBFtk8r6QE=";
