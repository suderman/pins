{
  citron = {
    ...
    version = "nightly-1772d01cd";
    url = "https://github.com/citron-neo/CI/releases/download/nightly-linux/citron_nightly-1772d01cd-linux-x86_64_v3.AppImage";
    sha256 = "sha256-p18YQaRuiYFGx/OAjb9LbDCoeYOFSyGf63rJknYU4Pg=";
