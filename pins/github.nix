{
  honcho = {
    ...
    repo = "honcho";
    rev = "v3.2.0";
    hash = "sha256-e1fAsSftCNJdFa53Y8OnmIsVM5yc/JgINZMND17EtL4=";
  ...
  nojoin = {
    ...
    redisImage = "redis:alpine@sha256:bd999b5cfee25fb24b8320a31fddbd69f462df44c8138c66e369582937beebc0";
